...
'''
PURPOSE: INTERFACING WITH THE SPOTIFY API, GETTING USER DATA, CREATING PLAYLISTS
'''
        ...
        for playlist_data in self.user_playlist_objects:
            for item in playlist_data['tracks']['items']:
                ...
                try:
                    ...
                    print 'error in getting artist data'
...
class SpotifyFunctionsPublic:
    ...
    def get_user_public_playlists(self, user_id, lim = 5): #50):
        '''
        INPUT: user_id
        OUTPUT: list of users public playlists
        '''
